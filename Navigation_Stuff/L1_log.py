...
def logArray(values):                                       # this function takes a 2-element array called val
    txt = open("/home/pi/mxet300_lab/basics/a.txt", 'w+')           # file for generic variable a
    txt2 = open("/home/pi/mxet300_lab/basics/b.txt", 'w+')          # file for generic variable b
    a = round(values[0], 2)
    b = round(values[1], 2)
    txt.write(str(a))
    txt2.write(str(b))
...
def uniqueFile(value, fileName):                            # this function takes a 2-element array called val
    txt = open("/home/pi/mxet300_lab/basics/log/" + fileName, 'w+')     # file with specified name
    myValue = round(value, 2)
    txt.write(str(myValue))
    txt.close()
    
def uniqueFilestr(value, fileName):                            # this function takes a 2-element array called val
    txt = open("/home/pi/mxet300_lab/basics/" + fileName, 'w+')     # file with specified name
    txt.write(str(value))
    txt.close()    
...
def csv_write(list):
    ...
    with open('/home/pi/mxet300_lab/basics/log/excel_data.csv', 'a') as csvFile:
